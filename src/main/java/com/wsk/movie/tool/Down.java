...
public class Down {
    ...
    public Down(){
        if (Os.isLinux()) {
            path = "/home/" + System.getProperty("user.name") + "/down/";
        }
    }
     ...
     * @throws IOException
     */
    public String down(String url) throws IOException {
     ...
     * @throws IOException
     */
    public String down(String url, String fileName) throws IOException {
